...
public enum ErrorCode {
    ...
    SSO_TICKET_INVALID(400210, 400, "INVALID_TICKET"),
    SSO_TICKET_CLIENT_MISMATCH(400211, 403, "CLIENT_MISMATCH"),
    SSO_TICKET_REDIRECT_URI_MISMATCH(400212, 403, "REDIRECT_URI_MISMATCH"),
    SSO_TICKET_STATE_MISMATCH(400213, 409, "STATE_MISMATCH"),
    SSO_TICKET_RATE_LIMITED(400214, 429, "RATE_LIMITED"),
    SSO_TICKET_SYSTEM_ERROR(400215, 500, "SYSTEM_ERROR");
